...
const require_versionSelector = require('./versionSelector-CoS6g9-B.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	return `https://${buildScriptHost({
		...
		proxyUrl,
		domain
	})}/npm/@clerk/ui@${require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.3.0")}/dist/ui.browser.js`;
};
