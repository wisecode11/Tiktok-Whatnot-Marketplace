...
import { y as buildErrorThrower } from "./error-D-ayZ5nL.mjs";
...
import { n as versionSelector } from "./versionSelector-BSa0YYBu.mjs";
...
const clerkUIScriptUrl = (opts) => {
	...
	return `https://${buildScriptHost({
		...
		proxyUrl,
		domain
	})}/npm/@clerk/ui@${versionSelector(__internal_clerkUIVersion, "1.3.0")}/dist/ui.browser.js`;
};
