...
function getInventoryStatusBadgeClass(status: string): string {
        ...
        <CardContent className="p-0">
          <div className="border-b border-border/60 bg-muted/20 px-4 py-4 md:px-6">
            <Tabs value={selectedTab} onValueChange={(value) => setSelectedTab(value as InventoryStatus)}>
              <TabsList className="inline-flex h-auto w-full flex-wrap gap-1 rounded-xl border border-border/50 bg-muted/50 p-1 sm:w-auto">
                <TabsTrigger value="ACTIVE" className={INVENTORY_TAB_TRIGGER_CLASS}>
                  Active
                </TabsTrigger>
                <TabsTrigger value="DRAFT" className={INVENTORY_TAB_TRIGGER_CLASS}>
                  Drafts
                </TabsTrigger>
                <TabsTrigger value="INACTIVE" className={INVENTORY_TAB_TRIGGER_CLASS}>
                  Inactive
                </TabsTrigger>
                <TabsTrigger value="SOLD_OUT" className={INVENTORY_TAB_TRIGGER_CLASS}>
                  Sold Out
                </TabsTrigger>
              </TabsList>
            </Tabs>
          ...
          <div className="space-y-4 p-4 md:p-6">
            <div className="flex flex-col gap-3 rounded-xl border border-border/50 bg-muted/20 p-3 md:flex-row md:items-center md:justify-between md:p-4">
              <Button
                variant="outline"
                size="icon"
                aria-label="Filters"
                className="h-10 w-10 shrink-0 rounded-lg bg-background shadow-sm"
              >
                <SlidersHorizontal className="h-4 w-4" />
              </Button>

              <div className="flex w-full flex-col gap-3 sm:flex-row sm:items-center md:w-auto">
                <div className="flex items-center gap-2.5 rounded-lg border border-border/50 bg-background px-3 py-2 text-sm text-muted-foreground">
                  <span className="font-medium text-foreground">Bulk edit</span>
                ...
                <div className="relative w-full sm:w-72">
                  ...
                  <Input
                    ...
                    className="h-10 rounded-lg border-border/60 bg-background pl-9 shadow-sm"
                  />
                </div>
              </div>
            </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-border/60 bg-muted/40 hover:bg-muted/40">
                    <TableHead className="h-11 w-[35%] text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                      Product
                    </TableHead>
                    ...
                    <TableHead className="h-11 text-right text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                      Actions
                    </TableHead>
                  </TableRow>
                </TableHeader>
                  ...
                  {isLoading ? (
                    ...
                    filteredItems.map((item) => (
                      ...
                      >
                        ...
                        <TableCell className="text-sm text-foreground/90">{item.category}</TableCell>
                        <TableCell>
                        ...
                        <TableCell>
                          <div className="space-y-1">
                            <p className="text-sm font-medium tabular-nums">{item.price}</p>
                        ...
                        <TableCell>
                          <Badge
                            variant="outline"
                            className={cn("font-medium uppercase tracking-wide", getInventoryStatusBadgeClass(item.condition))}
                          >
                            {item.condition}
                          </Badge>
                        </TableCell>
                    ...
                    <TableRow className="hover:bg-transparent">
                      <TableCell colSpan={7} className="py-16 text-center">
                        <div className="mx-auto flex max-w-sm flex-col items-center gap-2 text-sm text-muted-foreground">
                          ...
                          <p>No products found for {selectedTab.replace("_", " ").toLowerCase()}.</p>
                        </div>
                      </TableCell>
                    </TableRow>
                  )}
            ...
            <div className="flex flex-wrap items-center justify-between gap-2 rounded-lg border border-border/40 bg-muted/20 px-4 py-2.5 text-xs text-muted-foreground">
              <p className="font-medium">Show 20</p>
              <p>
